    ...
    <div className="self-stretch p-4 bg-neutral-800">
      <div className="self-stretch p-4 bg-gradient-to-b from-[#1d1d1d] to-[#272727] rounded-2xl outline-1 outline-offset-[-1px] outline-white/20 flex flex-col justify-start items-start gap-2">
        <textarea
          ...
          className="self-stretch bg-transparent text-neutral-200 text-xs font-medium font-['Pretendard'] leading-[14px] h-4 placeholder:text-zinc-500 focus:outline-none resize-none max-h-20 overflow-y-auto"
          rows={1}
        />
        <div className="self-stretch inline-flex justify-between items-end">
          ...
          <button
            ...
            onClick={handleSend}
            disabled={!input.trim()}
            className="px-3 py-1.5 bg-gradient-to-b from-neutral-700 to-zinc-800 rounded-lg outline-1 outline-offset-[-1px] outline-white/20 flex justify-center items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
