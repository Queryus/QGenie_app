...
export function TableDetailSidebar({
  ...
  return (
    <>
      <div
        className={`fixed inset-y-0 right-0 z-50 w-96 bg-[#1a1a1a] border-l border-[#393939] shadow-2xl transform transition-transform duration-300 ease-in-out ${
          ...
          <div className="flex flex-col h-full">
            <div className="flex items-center justify-between p-4 border-b border-[#393939]">
              <div className="flex items-center gap-2">
                <Table2 className="w-5 h-5 text-[#9F73FF]" />
              ...
              <Button
                ...
                size="icon"
                onClick={onClose}
                className="text-gray-400 hover:text-white hover:bg-[#393939]"
              >
                <X className="w-4 h-4" />
              </Button>
            </div>
                ...
                <div className="p-4 space-y-6">
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="bg-[#272727] rounded-lg p-3">
                        <div className="text-2xl font-bold text-[#9F73FF]">
                          {
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      {tableData.columns.map((column, index) => {
                        ...
                        return (
                          <div key={index} className="bg-[#272727] rounded-lg p-3 space-y-2">
                            <div className="flex items-center justify-between">
                              ...
                              <Badge
                                variant="outline"
                                className="text-xs border-[#393939] text-gray-400"
                              >
                                {column.type}
                              </Badge>
                            </div>
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="space-y-1">
                                {primaryKeys.map((col, idx) => (
                                  <div
                                    key={idx}
                                    className="flex items-center gap-2 text-sm text-gray-300 bg-[#272727] rounded px-3 py-2"
                                  >
